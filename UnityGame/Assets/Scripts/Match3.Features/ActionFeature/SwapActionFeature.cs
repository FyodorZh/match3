...
namespace Match3.Features
{
    public class SwapActionFeature : ActionFeature
    {
        ...
        public override void Process(IGame game, params CellId[] cells)
        {
            ...
            var mass1 = cell1.FindComponent<MassComponentFeature.IMass>();
            var mass2 = cell2.FindComponent<MassComponentFeature.IMass>();

            if (mass1 != null && !mass1.IsLocked &&
                mass2 != null && !mass2.IsLocked)
            {
                var move1 = cell1.FindComponent<MoveComponentFeature.IMove>();
                var move2 = cell2.FindComponent<MoveComponentFeature.IMove>();
