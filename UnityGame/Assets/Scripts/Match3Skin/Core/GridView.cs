...
namespace Match3.View
{
    ...
    {
        private IGridObserver _grid;

        public CellView _cellViewPrefab;

        private CellView[,] _cells;

        public void Setup(IGridObserver grid, IGameController controller, IViewFactory viewFactory)
        {
            _grid = grid;
            ...
            foreach (var cell in grid.AllCells)
            {
                ...
                view.Setup(cell, controller, viewFactory);
        ...
        public CellObjectView DeAttach(ICellObjectObserver cellObject, CellPosition oldPosition)
        {
